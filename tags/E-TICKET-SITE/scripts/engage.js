(function() {
	...
	if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = 'https://login.shareit.com';
    ...
    if (typeof janrain.settings.width === 'undefined')janrain.settings.width = '274';
    ...
    if (typeof janrain.settings.fontColor === 'undefined')janrain.settings.fontColor = '#000000';
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = 'piffbankjimgfjipckcg';
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = 'https://login.shareit.com';
    ...
    if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = '498004100228026';
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = 'https://login.shareit.com';
...
function _loadDynamicScript(src, callback) {
    ...
    function getPackagePath(packages) {
        ...
        var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('2013.1_ws_widgets_rc5');
        return path;
    }
